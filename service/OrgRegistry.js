...
return data;
 ...
 .then( async _instance => {
 return await  _instance. manageTrashType(code,name,UnitName,unitMaltiplier,price,{ from:_from, gas: _gas  });  })
 ...
 .then( async _instance => {
 return await  _instance. approve({ from:_from, gas: _gas  });  })
 ...
 .then( async _instance => {
 return await  _instance. addDelivery(location,time,code,amount,residnet,mapHash,account,{ from:_from, gas: _gas  });  })
 ...
 .then( async _instance => {
 return await  _instance. validateDeliverables(mapHash,points,account,{ from:_from, gas: _gas  });  })
 ...
 .then( async _instance => {
 return await  _instance. confirmPickup(mapHash,points,account,{ from:_from, gas: _gas  });  })
